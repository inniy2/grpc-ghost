...
cp ./config.ini          /var/lib/lxd/containers/u2/rootfs/etc/grpc-ghost/;
...
cp ./server.py           /var/lib/lxd/containers/u1/rootfs/root/grpc-ghost/;
cp ./config.ini          /var/lib/lxd/containers/u1/rootfs/etc/grpc-ghost/;
cp ./ghost_pb2.py        /var/lib/lxd/containers/u1/rootfs/root/grpc-ghost/;
cp ./ghost_pb2_grpc.py   /var/lib/lxd/containers/u1/rootfs/root/grpc-ghost/;

# sudo chown  -R '165536'.'165536'  /var/lib/lxd/containers/u1/rootfs/root/grpc-ghost
# sudo chown  -R '165536'.'165536'  /var/lib/lxd/containers/u2/rootfs/root/grpc-ghost

# sudo chown  -R '165536'.'165536'  /var/lib/lxd/containers/u1/rootfs/etc
# sudo chown  -R '165536'.'165536'  /var/lib/lxd/containers/u2/rootfs/etc
